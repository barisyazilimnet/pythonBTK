...
def delete_product(id):
    ...
    # sql ="delete from products where id = 5" ## idsi 5 olna kaydı siler
    ## delete /from / degiştirilcek tablo /eger where yazılmazsa bütün tabloyu temizler => where /temizlencek kayıt
    values = (id,)
    cursor.execute(sql, values)
    try:
        connection.commit()
